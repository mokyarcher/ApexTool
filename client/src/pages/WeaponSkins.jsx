...
const WEAPONS = [
  ...
  { id: 'r99', name: 'R-99', category: 'smg', image: '/weapons/r99.png', skins: [
    { id: 'r99-axle-launch-bundle', name: 'Axle Launch Bundle', rarity: '传说', image: '/weapons/r99/skins/axle-launch-bundle.jpg', model: '/weapons/r99/glb/axle-launch-bundle.glb' },
    { id: 'r99-beat-dropper', name: 'Beat Dropper', rarity: '传说', image: '/weapons/r99/skins/beat-dropper.jpg', model: '/weapons/r99/glb/beat-dropper.glb' },
    { id: 'r99-buzz-kill', name: 'Buzz Kill', rarity: '传说', image: '/weapons/r99/skins/buzz-kill.jpg', model: '/weapons/r99/glb/buzz-kill.glb' },
    { id: 'r99-frey-mythic', name: 'Frey Mythic', rarity: '神话', image: '/weapons/r99/skins/frey-mythic.jpg', model: '/weapons/r99/glb/frey-mythic.glb' },
    { id: 'r99-i-scream', name: 'I-Scream', rarity: '传说', image: '/weapons/r99/skins/i-scream.jpg', model: '/weapons/r99/glb/i-scream.glb' },
    { id: 'r99-ku-pow', name: 'KU-POW', rarity: '传说', image: '/weapons/r99/skins/ku-pow.jpg', model: '/weapons/r99/glb/ku-pow.glb' },
    { id: 'r99-outlands-avalanche', name: 'Outlands Avalanche', rarity: '传说', image: '/weapons/r99/skins/outlands-avalanche.jpg', model: '/weapons/r99/glb/outlands-avalanche.glb' },
    { id: 'r99-paradigm-shifter', name: 'Paradigm Shifter', rarity: '传说', image: '/weapons/r99/skins/paradigm-shifter.jpg', model: '/weapons/r99/glb/paradigm-shifter.glb' },
    { id: 'r99-solar-flare', name: 'Solar Flare', rarity: '传说', image: '/weapons/r99/skins/solar-flare.jpg', model: '/weapons/r99/glb/solar-flare.glb' },
    { id: 'r99-street-rush', name: 'Street Rush', rarity: '传说', image: '/weapons/r99/skins/street-rush.jpg', model: '/weapons/r99/glb/street-rush.glb' },
    { id: 'r99-swift-death', name: 'Swift Death', rarity: '传说', image: '/weapons/r99/skins/swift-death.jpg', model: '/weapons/r99/glb/swift-death.glb' },
    { id: 'r99-system-error', name: 'System Error', rarity: '传说', image: '/weapons/r99/skins/system-error.jpg', model: '/weapons/r99/glb/system-error.glb' },
  ] },
